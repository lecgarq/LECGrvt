...
internal sealed partial class ToolExecutor
{
    ...
    private static object AgentRead(UIDocument ui, Document doc, string operation, JsonElement args)
    {
        ...
        return operation switch
        {
            ...
            "base_points" => BasePoints(doc),
            "face_split_boundaries" => FaceSplitBoundaries(doc, args),
            "group_members" => GroupMembers(doc, args),
            "family_subcomponents" => FamilySubcomponents(doc, args),
            "assembly_members" => AssemblyMembers(doc, args),
            "mep_system_members" => MepSystemMembers(doc, args),
