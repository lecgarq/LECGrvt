...
internal static class ReviewedDiscovery
{
    ...
    private static readonly IReadOnlyDictionary<string, HashSet<string>> Vocabulary = new Dictionary<string, string[]>
    {
        ...
        ["group_members"] = ["group members contained elements", "miembros grupo elementos contenidos"],
        ["family_subcomponents"] = ["family nested subcomponents children", "familia subcomponentes anidados hijos"],
        ["assembly_members"] = ["assembly members contained elements", "miembros ensamblaje elementos contenidos"],
        ["mep_system_members"] = ["mep system members assigned elements", "miembros sistema mep elementos asignados"],
