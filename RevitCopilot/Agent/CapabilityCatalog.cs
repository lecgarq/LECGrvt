...
internal static class CapabilityCatalog
{
    ...
    [
        ...
        new("group_members", "read", "List the elements contained in one group", "{unique_id:string,limit?:int,offset?:int}"),
        new("family_subcomponents", "read", "List nested subcomponents of one family instance", "{unique_id:string,limit?:int,offset?:int}"),
        new("assembly_members", "read", "List the elements contained in one assembly instance", "{unique_id:string,limit?:int,offset?:int}"),
        new("mep_system_members", "read", "List the elements assigned to one MEP system", "{unique_id:string,limit?:int,offset?:int}"),
