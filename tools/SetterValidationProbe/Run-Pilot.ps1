param([ValidateSet('Pilot','Dedicated','ClassCollectors','NonElement','ProjectCorpus','Documented','DocumentedRetry','DocumentedNext','DocumentedNextRetry','DocumentedThird','DocumentedFourth','ProjectArchitecture','ProjectMepWire','ProjectGaps','Automatic','Restoration','Control','ReadOnly')][string]$Batch = 'Pilot')
...
try {
    ...
    if ($Batch -in @('ProjectCorpus','Documented','DocumentedRetry','DocumentedNext','DocumentedNextRetry','DocumentedThird','DocumentedFourth','ProjectArchitecture','ProjectMepWire','ProjectGaps') -and !$env:LECG_PROJECT_FIXTURE_ROOT) {
