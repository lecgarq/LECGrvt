param([ValidateSet('Pilot','Dedicated','ClassCollectors','NonElement','ProjectCorpus','Documented','DocumentedRetry','DocumentedNext','DocumentedNextRetry','DocumentedThird','DocumentedFourth','ProjectArchitecture','Automatic','Restoration','Control','ReadOnly')][string]$Batch = 'Pilot')
...
try {
    ...
    if ($Batch -in @('ProjectCorpus','Documented','DocumentedRetry','DocumentedNext','DocumentedNextRetry','DocumentedThird','DocumentedFourth','ProjectArchitecture') -and !$env:LECG_PROJECT_FIXTURE_ROOT) {
