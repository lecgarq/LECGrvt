param([ValidateSet('Pilot','Dedicated','ClassCollectors','NonElement','ProjectCorpus','Documented','DocumentedRetry','DocumentedNext','DocumentedNextRetry','DocumentedThird','Automatic','Restoration','Control','ReadOnly')][string]$Batch = 'Pilot')
...
try {
    ...
    if ($Batch -in @('ProjectCorpus','Documented','DocumentedRetry','DocumentedNext','DocumentedNextRetry','DocumentedThird') -and !$env:LECG_PROJECT_FIXTURE_ROOT) {
