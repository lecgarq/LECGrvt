param([ValidateSet('Pilot','Dedicated','ClassCollectors','NonElement','ProjectCorpus','Documented','DocumentedRetry','DocumentedNext','DocumentedNextRetry','DocumentedThird','DocumentedFourth','ProjectArchitecture','ProjectMepWire','ProjectMepCircuit','ProjectGaps','ProjectContextGaps','ProjectTypePresence','ProjectAccessorPresence','ProjectAccessorRead','ProjectNativeRead','ProjectNativePreview','ProjectViewSheetSet','Automatic','Restoration','Control','ReadOnly')][string]$Batch = 'Pilot')
...
try {
    ...
    if ($Batch -in @('ProjectCorpus','Documented','DocumentedRetry','DocumentedNext','DocumentedNextRetry','DocumentedThird','DocumentedFourth','ProjectArchitecture','ProjectMepWire','ProjectMepCircuit','ProjectGaps','ProjectContextGaps','ProjectTypePresence','ProjectAccessorPresence','ProjectAccessorRead','ProjectNativeRead','ProjectNativePreview','ProjectViewSheetSet') -and !$env:LECG_PROJECT_FIXTURE_ROOT) {
    ...
    try {
        ...
        $filter = switch($Batch) { 'Pilot' {'FullyQualifiedName~ChangedValuePilot'} 'Dedicated' {'FullyQualifiedName~DedicatedCollectionBatch.RunDedicated'} 'ClassCollectors' {'FullyQualifiedName~ClassCollectorBatch.RunClassCollector'} 'NonElement' {'FullyQualifiedName~NonElementBatch.RunNonElement'} 'ProjectCorpus' {'FullyQualifiedName~ProjectCorpusBatch.RunProjectCorpus'} 'Documented' {'FullyQualifiedName~DocumentedConstraintBatch.RunDocumented'} 'DocumentedRetry' {'FullyQualifiedName~DocumentedRetryBatch.RunDocumentedRetry'} 'DocumentedNext' {'FullyQualifiedName~DocumentedNextBatch.RunDocumentedNext'} 'DocumentedNextRetry' {'FullyQualifiedName~DocumentedNextRetryBatch.RunDocumentedNextRetry'} 'DocumentedThird' {'FullyQualifiedName~DocumentedThirdBatch.RunDocumentedThird'} 'DocumentedFourth' {'FullyQualifiedName~DocumentedFourthBatch.RunDocumentedFourth'} 'ProjectArchitecture' {'FullyQualifiedName~ProjectArchitectureBatch.RunProjectArchitecture'} 'ProjectMepWire' {'FullyQualifiedName~ProjectMepWireBatch.RunProjectMepWire'} 'ProjectMepCircuit' {'FullyQualifiedName~ProjectMepCircuitBatch.RunProjectMepCircuit'} 'ProjectGaps' {'FullyQualifiedName~ProjectGapBatch.RunProjectGaps'} 'ProjectContextGaps' {'FullyQualifiedName~ProjectContextGapBatch.RunProjectContextGaps'} 'ProjectTypePresence' {'FullyQualifiedName~ProjectTypePresenceBatch.ProfileSetterDeclaringTypes'} 'ProjectAccessorPresence' {'FullyQualifiedName~ProjectAccessorPresenceBatch.ProfileAccessorDeclaringTypes'} 'ProjectAccessorRead' {'FullyQualifiedName~ProjectAccessorReadBatch.ValidateAccessorsReadOnly'} 'ProjectNativeRead' {'FullyQualifiedName~ProjectNativeReadBatch.ValidateNativeReads'} 'ProjectNativePreview' {'FullyQualifiedName~ProjectNativePreviewBatch.ValidateNativePreviews'} 'ProjectViewSheetSet' {'FullyQualifiedName~ProjectViewSheetSetBatch.ClassifyPersistence'} 'Automatic' {'FullyQualifiedName~AutomaticPersistenceProbe.ProbePersistence'} 'Restoration' {'FullyQualifiedName~RestorationDiagnostic.InspectFailedRestoration'} 'Control' {'FullyQualifiedName~RestorationDiagnostic.InspectNoWriteRestoration'} }
        $expected = switch($Batch) { 'Pilot' {8} 'Dedicated' {14} 'ClassCollectors' {18} 'NonElement' {14} 'ProjectCorpus' {11} 'Documented' {4} 'DocumentedRetry' {3} 'DocumentedNext' {5} 'DocumentedNextRetry' {5} 'DocumentedThird' {6} 'DocumentedFourth' {6} 'ProjectArchitecture' {4} 'ProjectMepWire' {1} 'ProjectMepCircuit' {1} 'ProjectGaps' {3} 'ProjectContextGaps' {2} 'ProjectTypePresence' {1} 'ProjectAccessorPresence' {1} 'ProjectAccessorRead' {1} 'ProjectNativeRead' {1} 'ProjectNativePreview' {1} 'ProjectViewSheetSet' {3} 'Automatic' {1} 'Restoration' {1} 'Control' {1} }
