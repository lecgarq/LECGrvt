...
public sealed class DocumentedConstraintBatch : SetterHarness
{
    protected override string ManifestName => "documented-constraint-manifest.json";
    protected override string PreregistrationName => "documented-constraint-preregistration.md";
    protected override string RunKind => "documented-constraint-runs";
    ...
    public void RunDocumented(string property)
    {
