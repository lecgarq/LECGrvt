...
**Build:**
- `LECG.csproj:61-72` - `DeployToRevit` MSBuild target copies DLL/PDB/deps.json to `%APPDATA%\Autodesk\Revit\Addins\2026\LECG` unless `SkipRevitDeploy=true`
...
- Per-user deployment: `.addin` manifest at `%APPDATA%\Autodesk\Revit\Addins\2026\LECG.addin` (not generated by build; manually maintained)
- DLL/PDB/deps.json deployed to `%APPDATA%\Autodesk\Revit\Addins\2026\LECG\LECG.dll` etc. by `DeployToRevit` MSBuild target
