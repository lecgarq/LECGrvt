...
namespace LECG.ViewModels
{
    public partial class LogViewModel : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, System.IDisposable
    {
        ...
        public LogViewModel(ILogger logger)
        {
            ...
            CancelCommand = new CommunityToolkit.Mvvm.Input.RelayCommand(() => { IsCancelRequested = true; CanCancel = false; _logger.Log("Cancel requested. Finishing current material..."); });
        }
