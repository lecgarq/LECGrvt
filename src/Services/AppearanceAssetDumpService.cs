...
namespace LECG.Services
{
    public static class AppearanceAssetDumpService
    {
        ...
        {
            // ponytail: cap diagnostic recursion at 32 levels; track asset identity if deeper graphs are needed.
            if (depth > 32) { log("  [maximum asset depth reached]"); return; }
