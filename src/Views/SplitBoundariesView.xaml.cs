...
{
    public partial class SplitBoundariesView : LecgWindow
    {
        private readonly ISelectionCoordinator _selectionCoordinator;

        public SplitBoundariesView(SplitBoundariesViewModel vm, ISelectionCoordinator selectionCoordinator)
        {
            ...
            vm.Selection.OnRequestSelect += (s, e) =>
            {
                ...
                IList<Reference> refs = _selectionCoordinator.PickObjects(
                    ...
                    vm.Selection.Filter,
                    "Select Floors/Toposolids to Split");
                if (refs.Count > 0)
                {
