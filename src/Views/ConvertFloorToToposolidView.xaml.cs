...
{
    public partial class ConvertFloorToToposolidView : LecgWindow
    {
        private readonly ISelectionCoordinator _selectionCoordinator;

        public ConvertFloorToToposolidView(ConvertFloorToToposolidViewModel vm, ISelectionCoordinator selectionCoordinator)
        {
